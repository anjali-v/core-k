...
/* shit code */
static struct i2c_adapter *pAdap=NULL;
...
static int dummy_bcm2835_i2c_xfer(struct i2c_adapter *adap, struct i2c_msg msgs[],
			    int num)
{
	printk (KERN_INFO "%s: in %s\n", MODNAME, __FUNCTION__);
	return 0;
...
int bcm2835_i2c_xfer(struct i2c_adapter *adap, struct i2c_msg msgs[],
			    int num)
{
...
static const struct i2c_algorithm bcm2835_i2c_algo = {
	.master_xfer	= dummy_bcm2835_i2c_xfer,
...
static int bcm2835_i2c_probe(struct platform_device *pdev)
{
	...
	if (ret < 0) {
		...
		i2c_dev->bus_clk_rate = 400000;
	}
	i2c_dev->bus_clk_rate = 400000;
	printk (KERN_INFO "%s: %s i2c_clk_rate = %d\n", MODNAME, __FUNCTION__, i2c_dev->bus_clk_rate);
...
int bcm2835_i2c_get_adapter(struct i2c_adapter ** ppAdap)
{
    if (pAdap) *ppAdap = pAdap;
    else return -1;
    return 0;
}

EXPORT_SYMBOL(bcm2835_i2c_get_adapter);
EXPORT_SYMBOL(bcm2835_i2c_xfer);
